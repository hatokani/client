...
const SSL_Referee_Stage SSL_Referee_Stage_Stage_MIN =
    SSL_Referee_Stage_NORMAL_FIRST_HALF_PRE;
const SSL_Referee_Stage SSL_Referee_Stage_Stage_MAX =
...
inline bool SSL_Referee_Stage_Parse(const ::std::string &name,
                                    SSL_Referee_Stage *value) {
...
const SSL_Referee_Command SSL_Referee_Command_Command_MIN =
    SSL_Referee_Command_HALT;
const SSL_Referee_Command SSL_Referee_Command_Command_MAX =
    SSL_Referee_Command_GOAL_BLUE;
const int SSL_Referee_Command_Command_ARRAYSIZE =
    SSL_Referee_Command_Command_MAX + 1;

const ::google::protobuf::EnumDescriptor *SSL_Referee_Command_descriptor();
inline const ::std::string &
SSL_Referee_Command_Name(SSL_Referee_Command value) {
  return ::google::protobuf::internal::NameOfEnum(
      SSL_Referee_Command_descriptor(), value);
}
inline bool SSL_Referee_Command_Parse(const ::std::string &name,
                                      SSL_Referee_Command *value) {
...
public:
  ...
  inline void set_yellow_card_times(int index,
...
public:
  ...
  static const Stage Stage_MIN = SSL_Referee_Stage_Stage_MIN;
  static const Stage Stage_MAX = SSL_Referee_Stage_Stage_MAX;
  static const int Stage_ARRAYSIZE = SSL_Referee_Stage_Stage_ARRAYSIZE;
  ...
  static inline bool Stage_Parse(const ::std::string &name, Stage *value) {
  ...
  static const Command Command_MIN = SSL_Referee_Command_Command_MIN;
  static const Command Command_MAX = SSL_Referee_Command_Command_MAX;
  static const int Command_ARRAYSIZE = SSL_Referee_Command_Command_ARRAYSIZE;
  ...
  static inline bool Command_Parse(const ::std::string &name, Command *value) {
...
inline void
SSL_Referee_TeamInfo::set_red_cards(::google::protobuf::uint32 value) {
  set_has_red_cards();
  red_cards_ = value;
...
inline void
SSL_Referee_TeamInfo::set_yellow_cards(::google::protobuf::uint32 value) {
...
inline void
SSL_Referee_TeamInfo::set_timeouts(::google::protobuf::uint32 value) {
  set_has_timeouts();
  timeouts_ = value;
...
inline void
SSL_Referee_TeamInfo::set_timeout_time(::google::protobuf::uint32 value) {
...
inline void
SSL_Referee::set_packet_timestamp(::google::protobuf::uint64 value) {
...
inline void SSL_Referee::set_has_stage() { _has_bits_[0] |= 0x00000002u; }
inline void SSL_Referee::clear_has_stage() { _has_bits_[0] &= ~0x00000002u; }
...
inline void SSL_Referee::set_has_command() { _has_bits_[0] |= 0x00000008u; }
inline void SSL_Referee::clear_has_command() { _has_bits_[0] &= ~0x00000008u; }
...
inline void
SSL_Referee::set_command_timestamp(::google::protobuf::uint64 value) {
...
inline void SSL_Referee::set_has_yellow() { _has_bits_[0] |= 0x00000040u; }
inline void SSL_Referee::clear_has_yellow() { _has_bits_[0] &= ~0x00000040u; }
...
inline void SSL_Referee::set_has_blue() { _has_bits_[0] |= 0x00000080u; }
inline void SSL_Referee::clear_has_blue() { _has_bits_[0] &= ~0x00000080u; }
...
template <>
struct is_proto_enum<::SSL_Referee_Stage>
...
template <>
struct is_proto_enum<::SSL_Referee_Command>
    : ::google::protobuf::internal::true_type {};
template <>
