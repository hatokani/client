...
public:
  ...
  inline void
  set_penalty_spot_from_field_line_dist(::google::protobuf::int32 value);
...
public:
  ...
  inline SSL_GeometryCameraCalibration &
  operator=(const SSL_GeometryCameraCalibration &from) {
    CopyFrom(from);
    return *this;
  }
...
inline void
SSL_GeometryFieldSize::set_line_width(::google::protobuf::int32 value) {
  set_has_line_width();
  line_width_ = value;
...
inline void
SSL_GeometryFieldSize::set_field_length(::google::protobuf::int32 value) {
...
inline void
SSL_GeometryFieldSize::set_field_width(::google::protobuf::int32 value) {
  set_has_field_width();
  field_width_ = value;
...
inline void
SSL_GeometryFieldSize::set_boundary_width(::google::protobuf::int32 value) {
...
inline void
SSL_GeometryFieldSize::set_referee_width(::google::protobuf::int32 value) {
...
inline void
SSL_GeometryFieldSize::set_goal_width(::google::protobuf::int32 value) {
  set_has_goal_width();
  goal_width_ = value;
...
inline void
SSL_GeometryFieldSize::set_goal_depth(::google::protobuf::int32 value) {
  set_has_goal_depth();
  goal_depth_ = value;
...
SSL_GeometryFieldSize::goal_wall_width() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.goal_wall_width)
  return goal_wall_width_;
}
inline void
SSL_GeometryFieldSize::set_goal_wall_width(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32
SSL_GeometryFieldSize::center_circle_radius() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.center_circle_radius)
  return center_circle_radius_;
}
inline void SSL_GeometryFieldSize::set_center_circle_radius(
...
inline void
SSL_GeometryFieldSize::set_defense_radius(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32
SSL_GeometryFieldSize::defense_stretch() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.defense_stretch)
  return defense_stretch_;
}
inline void
SSL_GeometryFieldSize::set_defense_stretch(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32
SSL_GeometryFieldSize::free_kick_from_defense_dist() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.free_kick_from_defense_dist)
  return free_kick_from_defense_dist_;
}
inline void SSL_GeometryFieldSize::set_free_kick_from_defense_dist(
    ::google::protobuf::int32 value) {
...
// required int32 penalty_spot_from_field_line_dist = 13;
inline bool
SSL_GeometryFieldSize::has_penalty_spot_from_field_line_dist() const {
...
inline void
SSL_GeometryFieldSize::clear_has_penalty_spot_from_field_line_dist() {
  _has_bits_[0] &= ~0x00001000u;
}
...
inline ::google::protobuf::int32
SSL_GeometryFieldSize::penalty_spot_from_field_line_dist() const {
...
inline ::google::protobuf::int32
SSL_GeometryFieldSize::penalty_line_from_spot_dist() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryFieldSize.penalty_line_from_spot_dist)
  return penalty_line_from_spot_dist_;
}
inline void SSL_GeometryFieldSize::set_penalty_line_from_spot_dist(
    ::google::protobuf::int32 value) {
...
SSL_GeometryCameraCalibration::camera_id() const {
  // @@protoc_insertion_point(field_get:SSL_GeometryCameraCalibration.camera_id)
  return camera_id_;
}
inline void
SSL_GeometryCameraCalibration::set_camera_id(::google::protobuf::uint32 value) {
  set_has_camera_id();
  camera_id_ = value;
...
inline void
SSL_GeometryCameraCalibration::set_derived_camera_world_tx(float value) {
...
inline void
SSL_GeometryCameraCalibration::set_derived_camera_world_ty(float value) {
...
inline void
SSL_GeometryCameraCalibration::set_derived_camera_world_tz(float value) {
...
inline void SSL_GeometryData::set_has_field() { _has_bits_[0] |= 0x00000001u; }
...
inline void
SSL_GeometryData::set_allocated_field(::SSL_GeometryFieldSize *field) {
  delete field_;
  field_ = field;
  if (field) {
    set_has_field();
...
// repeated .SSL_GeometryCameraCalibration calib = 2;
inline int SSL_GeometryData::calib_size() const { return calib_.size(); }
inline void SSL_GeometryData::clear_calib() { calib_.Clear(); }
inline const ::SSL_GeometryCameraCalibration &
SSL_GeometryData::calib(int index) const {
  // @@protoc_insertion_point(field_get:SSL_GeometryData.calib)
  return calib_.Get(index);
}
inline ::SSL_GeometryCameraCalibration *
SSL_GeometryData::mutable_calib(int index) {
