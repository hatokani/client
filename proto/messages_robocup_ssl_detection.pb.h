...
inline void SSL_DetectionBall::set_has_area() { _has_bits_[0] |= 0x00000002u; }
...
inline void SSL_DetectionBall::set_has_x() { _has_bits_[0] |= 0x00000004u; }
inline void SSL_DetectionBall::clear_has_x() { _has_bits_[0] &= ~0x00000004u; }
...
inline void SSL_DetectionBall::set_has_y() { _has_bits_[0] |= 0x00000008u; }
inline void SSL_DetectionBall::clear_has_y() { _has_bits_[0] &= ~0x00000008u; }
...
inline void SSL_DetectionBall::set_has_z() { _has_bits_[0] |= 0x00000010u; }
inline void SSL_DetectionBall::clear_has_z() { _has_bits_[0] &= ~0x00000010u; }
...
inline void SSL_DetectionRobot::set_has_x() { _has_bits_[0] |= 0x00000004u; }
inline void SSL_DetectionRobot::clear_has_x() { _has_bits_[0] &= ~0x00000004u; }
...
inline void SSL_DetectionRobot::set_has_y() { _has_bits_[0] |= 0x00000008u; }
inline void SSL_DetectionRobot::clear_has_y() { _has_bits_[0] &= ~0x00000008u; }
...
inline void
SSL_DetectionFrame::set_frame_number(::google::protobuf::uint32 value) {
...
inline void
SSL_DetectionFrame::set_camera_id(::google::protobuf::uint32 value) {
  set_has_camera_id();
  camera_id_ = value;
...
// repeated .SSL_DetectionBall balls = 5;
inline int SSL_DetectionFrame::balls_size() const { return balls_.size(); }
inline void SSL_DetectionFrame::clear_balls() { balls_.Clear(); }
...
inline const ::SSL_DetectionRobot &
SSL_DetectionFrame::robots_yellow(int index) const {
  // @@protoc_insertion_point(field_get:SSL_DetectionFrame.robots_yellow)
  return robots_yellow_.Get(index);
}
inline ::SSL_DetectionRobot *
SSL_DetectionFrame::mutable_robots_yellow(int index) {
...
inline void SSL_DetectionFrame::clear_robots_blue() { robots_blue_.Clear(); }
inline const ::SSL_DetectionRobot &
SSL_DetectionFrame::robots_blue(int index) const {
  // @@protoc_insertion_point(field_get:SSL_DetectionFrame.robots_blue)
  return robots_blue_.Get(index);
}
inline ::SSL_DetectionRobot *
SSL_DetectionFrame::mutable_robots_blue(int index) {
