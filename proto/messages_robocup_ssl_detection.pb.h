...
class SSL_DetectionBall : public ::google::protobuf::Message {
 public:
  ...
  inline SSL_DetectionBall* New() const { return New(NULL); }

  SSL_DetectionBall* New(::google::protobuf::Arena* arena) const;
...
class SSL_DetectionRobot : public ::google::protobuf::Message {
 public:
  ...
  inline SSL_DetectionRobot* New() const { return New(NULL); }

  SSL_DetectionRobot* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class SSL_DetectionFrame : public ::google::protobuf::Message {
 public:
  ...
  inline SSL_DetectionFrame* New() const { return New(NULL); }

  SSL_DetectionFrame* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
