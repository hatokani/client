...
void protobuf_AssignDesc_messages_5frobocup_5fssl_5fwrapper_2eproto() {
  ...
  static const int SSL_WrapperPacket_offsets_[2] = {
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_WrapperPacket,
                                                     detection_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_WrapperPacket,
                                                     geometry_),
  };
...
void protobuf_AddDesc_messages_5frobocup_5fssl_5fwrapper_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(
      &protobuf_ShutdownFile_messages_5frobocup_5fssl_5fwrapper_2eproto);
}
...
SSL_WrapperPacket::SSL_WrapperPacket() : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:SSL_WrapperPacket)
}

void SSL_WrapperPacket::InitAsDefaultInstance() {
  detection_ = const_cast<::SSL_DetectionFrame *>(
      &::SSL_DetectionFrame::default_instance());
  geometry_ =
      const_cast<::SSL_GeometryData *>(&::SSL_GeometryData::default_instance());
}
...
::google::protobuf::uint8 *SSL_WrapperPacket::SerializeWithCachedSizesToArray(
  ...
  if (has_detection()) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteMessageNoVirtualToArray(1, this->detection(), target);
  }

  // optional .SSL_GeometryData geometry = 2;
  if (has_geometry()) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteMessageNoVirtualToArray(2, this->geometry(), target);
  }
...
bool SSL_WrapperPacket::IsInitialized() const {
  ...
  if (has_detection()) {
    if (!this->detection().IsInitialized())
      return false;
  }
  if (has_geometry()) {
    if (!this->geometry().IsInitialized())
      return false;
  }
  return true;
}
