...
void protobuf_AssignDesc_messages_5frobocup_5fssl_5fdetection_2eproto() {
  ...
  static const int SSL_DetectionBall_offsets_[7] = {
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionBall,
                                                     confidence_),
  ...
  static const int SSL_DetectionRobot_offsets_[8] = {
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionRobot,
                                                     confidence_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionRobot,
                                                     robot_id_),
  ...
  static const int SSL_DetectionFrame_offsets_[7] = {
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionFrame,
                                                     frame_number_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionFrame,
                                                     t_capture_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_DetectionFrame,
...
void protobuf_AddDesc_messages_5frobocup_5fssl_5fdetection_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(
      &protobuf_ShutdownFile_messages_5frobocup_5fssl_5fdetection_2eproto);
}
...
SSL_DetectionBall::SSL_DetectionBall() : ::google::protobuf::Message() {
  SharedCtor();
...
#define OFFSET_OF_FIELD_(f)                                                    \
  (reinterpret_cast<char *>(&reinterpret_cast<SSL_DetectionBall *>(16)->f) -   \
...
void SSL_DetectionBall::SerializeWithCachedSizes(
  ...
  if (has_confidence()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(
        1, this->confidence(), output);
  }

  // optional uint32 area = 2;
  if (has_area()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->area(),
                                                              output);
  }

  // required float x = 3;
  if (has_x()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->x(),
                                                             output);
  }

  // required float y = 4;
  if (has_y()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->y(),
                                                             output);
  }

  // optional float z = 5;
  if (has_z()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(5, this->z(),
                                                             output);
  }

  // required float pixel_x = 6;
  if (has_pixel_x()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(6, this->pixel_x(),
                                                             output);
  }

  // required float pixel_y = 7;
  if (has_pixel_y()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(7, this->pixel_y(),
                                                             output);
  }
...
::google::protobuf::uint8 *SSL_DetectionBall::SerializeWithCachedSizesToArray(
  ...
  if (has_pixel_x()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(
        6, this->pixel_x(), target);
  }

  // required float pixel_y = 7;
  if (has_pixel_y()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(
        7, this->pixel_y(), target);
  }
...
bool SSL_DetectionBall::IsInitialized() const {
  if ((_has_bits_[0] & 0x0000006d) != 0x0000006d)
    return false;
...
SSL_DetectionRobot::SSL_DetectionRobot() : ::google::protobuf::Message() {
  SharedCtor();
...
#define OFFSET_OF_FIELD_(f)                                                    \
  (reinterpret_cast<char *>(&reinterpret_cast<SSL_DetectionRobot *>(16)->f) -  \
   reinterpret_cast<char *>(16))
...
void SSL_DetectionRobot::SerializeWithCachedSizes(
  ...
  // optional float height = 8;
  if (has_height()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(8, this->height(),
                                                             output);
  }
...
SSL_DetectionFrame::SSL_DetectionFrame() : ::google::protobuf::Message() {
  SharedCtor();
...
#define OFFSET_OF_FIELD_(f)                                                    \
  (reinterpret_cast<char *>(&reinterpret_cast<SSL_DetectionFrame *>(16)->f) -  \
   reinterpret_cast<char *>(16))
...
void SSL_DetectionFrame::SerializeWithCachedSizes(
  ...
  if (has_t_capture()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(
        2, this->t_capture(), output);
  }

  // required double t_sent = 3;
  if (has_t_sent()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(3, this->t_sent(),
                                                              output);
  }
...
::google::protobuf::uint8 *SSL_DetectionFrame::SerializeWithCachedSizesToArray(
  ...
  if (has_frame_number()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
        1, this->frame_number(), target);
  }

  // required double t_capture = 2;
  if (has_t_capture()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(
        2, this->t_capture(), target);
  }

  // required double t_sent = 3;
  if (has_t_sent()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(
        3, this->t_sent(), target);
  }
  ...
  for (int i = 0; i < this->balls_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteMessageNoVirtualToArray(5, this->balls(i), target);
  }

  // repeated .SSL_DetectionRobot robots_yellow = 6;
  for (int i = 0; i < this->robots_yellow_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteMessageNoVirtualToArray(6, this->robots_yellow(i), target);
  }

  // repeated .SSL_DetectionRobot robots_blue = 7;
  for (int i = 0; i < this->robots_blue_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteMessageNoVirtualToArray(7, this->robots_blue(i), target);
  }
...
bool SSL_DetectionFrame::IsInitialized() const {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->balls()))
    return false;
  if (!::google::protobuf::internal::AllAreInitialized(this->robots_yellow()))
    return false;
  if (!::google::protobuf::internal::AllAreInitialized(this->robots_blue()))
    return false;
  return true;
}
