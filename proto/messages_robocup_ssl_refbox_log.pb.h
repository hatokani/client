...
public:
  ...
  inline void set_allocated_frame(::SSL_DetectionFrame *frame);
  ...
  inline void set_allocated_refbox_cmd(::std::string *refbox_cmd);
...
inline void Log_Frame::set_has_frame() { _has_bits_[0] |= 0x00000001u; }
inline void Log_Frame::clear_has_frame() { _has_bits_[0] &= ~0x00000001u; }
...
inline void Log_Frame::set_has_refbox_cmd() { _has_bits_[0] |= 0x00000002u; }
inline void Log_Frame::clear_has_refbox_cmd() { _has_bits_[0] &= ~0x00000002u; }
...
// repeated .Log_Frame log = 1;
inline int Refbox_Log::log_size() const { return log_.size(); }
inline void Refbox_Log::clear_log() { log_.Clear(); }
