...
class Log_Frame : public ::google::protobuf::Message {
 public:
  ...
  inline Log_Frame* New() const { return New(NULL); }

  Log_Frame* New(::google::protobuf::Arena* arena) const;
...
class Refbox_Log : public ::google::protobuf::Message {
 public:
  ...
  inline Refbox_Log* New() const { return New(NULL); }

  Refbox_Log* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
